...
<template>
  <NuxtLink
    ...
    class="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl no-underline text-inherit transition-all hover:border-[#e94560] hover:shadow-md hover:-translate-y-0.5 group"
  >
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex items-center gap-2 mt-1">
        ...
        <span class="text-xs text-gray-400">{{ output.activity_date }}</span>
      </div>
    </div>
